        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/app-development" className="text-sm text-muted-foreground hover:text-primary">
                  App Development
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services/content" className="text-sm text-muted-foreground hover:text-primary">
                  Content Creation
                </Link>
              </li>
            </ul>
